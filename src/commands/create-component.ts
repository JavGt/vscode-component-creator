...
import { createBarrer, createComponent, createFolder, createStyles } from '../creators';
...
const createComponentFn = async (ctx: ExtensionContext, args: any) => {
	...
	const extensionStyle =
		styleType === STYLE_OPTIONS.component.value || styleType === STYLE_OPTIONS.none.value
	...
	if (extensionStyle !== STYLE_OPTIONS.none.value)
		createStyles(folderPath, nameComponent, styleType, extensionStyle as ExtensionStyle);
